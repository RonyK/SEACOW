...
//
//	public:
//		mmt_old(dim_vector_reference dim, dim_vector_reference chunkDim, size_const maxLevel)
//		{
//			this->dim_ = dim;
...
//		~mmt_old() {}
//
//		void build(value_pointer data, size_const length)
//		{
//			//////////////////////////////
//			// Forward build
...
//		}
//
//		const mmt_old<Dty_, Ty_>::mmtNode* getNodes(size_type level)
//		{
