...
template<class Ty_>
void spiht_decode_action::decode_progress(size_t dSize, std::vector<position_t> cSize, std::vector<size_t> bandSize, chunkItemIterator itemItr)
{
...
template<class Ty_>
void spiht_decode_action::decode_sigpass(size_t dSize, std::vector<position_t> cSize, std::vector<size_t> bandSize,
...
template<class Ty_>
void spiht_decode_action::decode_refinepass(chunkItemIterator itemItr, Ty_ stepBit, size_t LSP_size)
{
