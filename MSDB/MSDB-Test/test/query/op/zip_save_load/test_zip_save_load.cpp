...
{
TEST(query_op_zip, star1024x1024_ind_compass_encode_decode)
{
...
{
TEST(query_op_zip, saturn1024x1024_ind_compass_encode_decode)
{
	test_qry_ind_zip_save<value_type>(&getSourceArrayIfEmpty,
									  &getSourceArrayDesc);
}
...
{
TEST(query_op_zip, solar1024x1024_ind_compass_encode_decode)
{
	test_qry_ind_zip_save<value_type>(&getSourceArrayIfEmpty,
									  &getSourceArrayDesc);
}
...
{
TEST(query_op_zip, mars4096x2048_ind_compass_encode_decode)
{
	test_qry_ind_zip_save<value_type>(&getSourceArrayIfEmpty,
									  &getSourceArrayDesc);
}
